...
unless ($@) {
  Log::Log4perl::init('/home/hgallu/meme/share/meme-5.1.1/logging.conf');
  $logger = Log::Log4perl->get_logger('meme.service.utils');
}

my $service_invocation_log_dir = '/home/hgallu/meme/var/meme-5.1.1/LOGS';
my $tmpdir = '';
...
sub update_status {
  ...
  my $template = HTML::Template->new(filename => '/home/hgallu/meme/share/meme-5.1.1/job_status.tmpl');
